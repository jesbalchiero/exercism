...
export function remainingMinutesInOven(actualMinutesInOven) {
  const timeRemainingMinutesInOven =
    EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
  return timeRemainingMinutesInOven;
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  const preparationTimeInMinutesOfLayers =
    PREPARATION_MINUTES_PER_LAYER * numberOfLayers;
  return preparationTimeInMinutesOfLayers;
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  ...
  return actualMinutesInOven + preparationTimeInMinutesOfLayers;
}
